...
const PrimaryButton = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "w-52 bg-slate-900 overflow-hidden relative group hover:bg-green-700 text-white font-black py-4 rounded-[2rem] transition-all duration-500 shadow-xl shadow-slate-200 hover:shadow-green-200 uppercase tracking-[0.2em] text-[0.75rem] flex items-center justify-center gap-3 active:scale-95",
        className
      )}
    >
